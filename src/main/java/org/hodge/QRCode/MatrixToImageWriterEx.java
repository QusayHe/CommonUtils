...
public class MatrixToImageWriterEx {
	 ...
	 *            要写入照片的路径
	 * @param logoConfig
	 *            logo配置对象 可以为null，为 null 默认 DEFAULT_CONFIG
	 * @throws IOException
	 */
	public static void overlapImage(BitMatrix matrix, String formate, String logoPath,
			MatrixToLogoImageConfig logoConfig, OutputStream out) throws IOException {
	 ...
	 * @throws IOException
	 */
	public static void overlapImage(BufferedImage image, String formate, String logoPath,
			MatrixToLogoImageConfig logoConfig, OutputStream out) throws IOException {
		// 将logo照片绘制到二维码中间
		drawImage(logoPath, image, logoConfig);
	 ...
	 * @throws IOException
	 */
	private static void drawImage(String logoPath, BufferedImage image, MatrixToLogoImageConfig logoConfig)
			throws IOException {
		if (logoConfig == null) {
